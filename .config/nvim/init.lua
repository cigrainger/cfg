...
keys = {
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { "<leader>i", group = "[I]ntelligence", mode = { "n", "v" } },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          vim.keymap.set("n", "<leader>D", fzf.lsp_typedefs, { desc = "Type [D]efinition" })
      ...
      local servers = {
        ...
        -- ts_ls = {},
        --
        lexical = { cmd = { "/Users/chris/code/lexical/_build/dev/package/lexical/bin/start_lexical.sh" } },
        tailwindcss = {
          settings = {
            tailwindCSS = {
        ...
        ts_ls = {}, -- Modern TypeScript/JavaScript server, better than tsserver
        ...
        -- HTML/Templates
        html = {},
        emmet_ls = { filetypes = { "html", "css", "elixir", "eelixir", "heex" } }, -- Provides Emmet completion for HTML/CSS
  ...
  },
  {
    ...
    event = "VeryLazy",
    keys = function()
      local function ensure_key_and_run(cmd)
        return function()
          if not vim.env.ANTHROPIC_API_KEY then
            vim.env.ANTHROPIC_API_KEY =
              vim.fn.system('op read "op://Engineering/Anthropic API Key/api key"'):gsub("\n", "")
          end
          vim.cmd(cmd)
        end
      end
      ...
      return {
        { "<leader>ia", ensure_key_and_run("CodeCompanionActions"), mode = "n", desc = "CodeCompanion Actions" },
        { "<leader>ia", ensure_key_and_run("CodeCompanionActions"), mode = "v", desc = "CodeCompanion Actions" },
        { "<leader>it", ensure_key_and_run("CodeCompanionChat Toggle"), mode = "n", desc = "Toggle Chat" },
        { "<leader>it", ensure_key_and_run("CodeCompanionChat Toggle"), mode = "v", desc = "Toggle Chat" },
        { "<leader>in", ensure_key_and_run("CodeCompanionChat"), mode = "n", desc = "Toggle Chat" },
        { "<leader>in", ensure_key_and_run("CodeCompanionChat"), mode = "v", desc = "Toggle Chat" },
        { "ga", ensure_key_and_run("CodeCompanionChat Add"), mode = "v", desc = "Add to Chat" },
        {
          "<leader>ii",
          function()
            if not vim.env.ANTHROPIC_API_KEY then
    ...
    config = function()
      -- Create the ensure_key function
      ...
      -- Override the CodeCompanion command to ensure key is loaded
  ...
  },
  {
    ...
    keys = {
      ...
      },
      {
        ...
        desc = "Open [S]pectre on selection",
      },
      {
        "<leader>Sf",
        function()
